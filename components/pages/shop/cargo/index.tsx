...
const CargoView: React.FC<CargoViewProps> = (props: CargoViewProps) => {
  ...
  const socialItems = [
    { icon: <FaGithub />, href: "https://github.com/Tehila03" },
    {
      icon: <FaLinkedin />,
    ...
    },
    {
      ...
      href: "https://tehila-portfolio-7500d2d37584.herokuapp.com/",
    },
  ];
          ...
          <ShowOnViewport customClass={styles.emptyCartPoem}>
            <>
              ...
              <p>
                ...
                your cup from every corner of the world.
              </p>
              <p>
                Your cart is not just empty; it`s a vessel waiting to be filled
                with the finest coffee treasures from diverse coffee cultures.
              </p>
              <p>
                Start adding your favorite brews now, and get ready to set sail
                on a worldwide coffee expedition.
              </p>
              <Link href={"/shop"}>
                <a className={styles.emptyCartButton}>travel the world</a>
              </Link>
            </>
          </ShowOnViewport>
        )}
